...
enter the filter type window Fs order= lowpass hann 100 128 /n
...
enter the filter type window Fs order= highpass blackman 100 64 /n
...
enter the filter type window Fs order= bandpass blackmannuttall 200 84 /n
enter the frequncy passband fc1 fc2 = 2.2 4.4 /n
...
enter the frequncy stopband fc1 fc2 = 10 15 /n
